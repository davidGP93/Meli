    ...
    <Layout>
      ...
      <div className={indexStyles.generalContainerDetailProduct}>
        <div className={indexStyles.dataArt}>
          <div>
            <img
              src={dataProduct.pictures[currentImage].secure_url}
              alt={dataProduct.title}
            />
            <Pictures
              listPictures={dataProduct.pictures}
              handleCurrentImage={handleCurrentImage}
            />
          </div>

          <div className={indexStyles.infoArt}>
            <span className={indexStyles.soldQuantity}>
              {dataProduct.condition === "new" ? "Nuevo" : "Antiguo"} -{" "}
              {dataProduct.sold_quantity} vendidos
            </span>
            ...
            {dataProduct.accepts_mercadopago ? (
        ...
        <div className={indexStyles.description}>
          <span className={indexStyles.titleDescription}>
            Descripción del producto
          </span>
          <span className={indexStyles.textDescription}>
